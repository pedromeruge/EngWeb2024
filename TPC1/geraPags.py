...
def generate_para_html(elem, withTag: bool):
    html = "            <h3>" if withTag is True else ""
...
def generate_lista_casas_html(elem):
    ...
    for casa_elem in elem.findall("casa"):
        ...
        vista = casa_elem.find("vista").text if casa_elem.find("vista") else "-"
...
def generate_figura_html(elem):
    ...
    html=f"""
            <div class="w3-card-4">
                <img src={"../dataset/" + elem.find("imagem").attrib["path"][3:]} alt="foto não carregou">
