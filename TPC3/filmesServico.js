    ...
    <!DOCTYPE html>
        ...
        if (ator.idFilmes != '') {
            ator.idFilmes.forEach(filme => {
                ...
                pagHTML += `                            
                                    <li><a href="/filmes/${filme}">${filme}</a></li>
                `
            })
        }
...
function genAtores(atores) {
    ...
    atores.forEach(ator => {
        ...
        pagHTML += `
                        <tr>
                            <td><a href="/generos/${ator.id}">${ator.id}</a></td> 
                            <td>${ator.nomeAtor}</td>
                            <td>
                                <ul>
        `
...
function genFilme(filme) {
    ...
    if (filme.cast != '') {
        filme.cast.forEach(castMember => {
            pagHTML += `    
                                <li><a href="/atores/${castMember}">${castMember}</a></li>
            `
        })
    }
    pagHTML += `        </ul>
    ...
    if (filme.genres != '') {
        filme.genres.forEach(genre => {
            pagHTML += `    
                            <li><a href="/generos/${genre}">${genre}</a></li>
            `
        })
    }
...
http.createServer(function(req,res) {
    ...
    } else if (q.pathname == "/w3.css"){  // interpretar o ficheiro /w3.css
    ...
    } else if (q.pathname == "/styles.css"){  // interpretar o ficheiro /styles.css
